(function ($) {
    ...
    function qodeDemosAjax() {
        var qodeDemo = $('.qode-demos-toolbar').data("demo"),
            qodeTopOffest = $('.qode-demos-toolbar').data("position");

        $.ajax({
            url: 'https://toolbar.qodeinteractive.com/templates/qode-toolbar-profile.php',
            //url: 'http://192.168.1.212:3000/wp-content/plugins/qode-demos-toolbar/templates/qode-toolbar-profile.php',
            type: "GET",
            data: {
                demo: qodeDemo,
